...
func get_tower_display_name(tower_id: String, fallback: String = "") -> String:
...
## 若翻译键不存在则回退到 data.display_name
func get_enemy_display_name(enemy_id: String, fallback: String = "") -> String:
...
func get_item_display_name(item_id: String, fallback: String = "") -> String:
...
func tr_tower_name(data: Resource) -> String:
...
func tr_item_name(data: Resource) -> String:
...
func tr_enemy_name(data: Resource) -> String:
